...
using SignalRWebUI.Dtos.NotificitionDtos;
using System.Text;
...
namespace SignalRWebUI.Controllers
{
	public class NotificationsController : Controller
	{
		...
		[HttpPost]
		public async Task<IActionResult> CreateNotification(CreateNatificationDto createNotificationDto)
		{
			var client = _httpClientFactory.CreateClient();
		...
		[HttpPost]
		public async Task<IActionResult> UpdateNotification(UpdateNatificationDto updateNotificationDto)
		{
			var client = _httpClientFactory.CreateClient();
